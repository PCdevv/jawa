...
public class LaundryFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        optionJenisCuci.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        optionJenisCuci.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Pilih", "Cuci Kering", "Cuci Basah", "Cuci Setrika" }));
        optionJenisCuci.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                optionJenisCuciActionPerformed(evt);
            }
        });
        jPanel1.add(optionJenisCuci, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 140, 200, -1));

        txtBayar.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jPanel1.add(txtBayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 310, 200, -1));

        txtHarga.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jPanel1.add(txtHarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 200, -1));
        ...
        jPanel1.add(txtBerat, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 230, 200, -1));

        txtTotalHarga.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jPanel1.add(txtTotalHarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 270, 200, -1));
        ...
        jPanel1.add(btnTransaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 430, 110, -1));
        ...
        jPanel1.add(btnBatal, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 430, 80, -1));
    ...
    private void btnTransaksiActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnTransaksiActionPerformed
        ...
        if (txtBayar.getText().isEmpty() || txtBerat.getText().isEmpty() || txtHarga.getText().isEmpty()
            ...
            JOptionPane.showMessageDialog(null, "Transaksi berhasil, kembalian anda : \n" + kembalian);
            reset();
        }

    }// GEN-LAST:event_btnTransaksiActionPerformed

    private void btnBatalActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnTransaksiActionPerformed
        reset();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaundryFrame.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
